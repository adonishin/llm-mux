...
// DefaultThinkingBudgetsForClaude provides standard level-to-budget mapping for Claude models.
var DefaultThinkingBudgetsForClaude = ThinkingBudgets{
	Low:    8192,
	Medium: 16384,
	High:   24576,
	Max:    32768,
...
func GetClaudeModels() []*ModelInfo {
	return []*ModelInfo{
		...
		Claude("claude-sonnet-4-5-thinking").Display("Claude 4.5 Sonnet Thinking").Created(1759104000).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelHigh, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
		Claude("claude-sonnet-4-5-thinking-low").Display("Claude 4.5 Sonnet Thinking Low").Created(1759104000).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelLow, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
		Claude("claude-sonnet-4-5-thinking-medium").Display("Claude 4.5 Sonnet Thinking Medium").Created(1759104000).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelMedium, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
		Claude("claude-sonnet-4-5-thinking-high").Display("Claude 4.5 Sonnet Thinking High").Created(1759104000).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelHigh, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
		Claude("claude-opus-4-5-thinking").Display("Claude 4.5 Opus Thinking").Created(1761955200).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelHigh, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
		Claude("claude-opus-4-5-thinking-low").Display("Claude 4.5 Opus Thinking Low").Created(1761955200).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelLow, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
		Claude("claude-opus-4-5-thinking-medium").Display("Claude 4.5 Opus Thinking Medium").Created(1761955200).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelMedium, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
		Claude("claude-opus-4-5-thinking-high").Display("Claude 4.5 Opus Thinking High").Created(1761955200).Context(200000, 64000).
			ThinkingWithLevel(ThinkingLevelHigh, DefaultThinkingBudgetsForClaude, 8192, 32768).B(),
